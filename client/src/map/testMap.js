...
class Map extends Component {
    ...
    componentWillMount() {
        this.state.zoom = codes[this.state.flights[0]];

        for (var airports of this.state.flights) {
            var coords = codes[airports];
            this.state.latitudes.push(coords[1]);
            this.state.longitudes.push(coords[0]);
            var city = {
                "svgPath" : targetSVG,
                "title" : airports,
                "latitude" : coords[1],
